...
(function (global) {
    ...
    iDisqus.prototype.init = function(){
        ...
        _.dom.innerHTML = '<div class="comment loading" id="idisqus">\n'+
            ...
            '                                <path d="M512 1024c-282.713043 0-512-229.286957-512-512s229.286957-512 512-512c282.713043 0 512 229.286957 512 512S792.486957 1024 512 1024zM512 44.521739c-258.226087 0-467.478261 209.252174-467.478261 467.478261 0 258.226087 209.252174 467.478261 467.478261 467.478261s467.478261-209.252174 467.478261-467.478261C979.478261 253.773913 768 44.521739 512 44.521739z"/>\n'+
            '                                <path d="M801.391304 554.295652c0 160.278261-129.113043 289.391304-289.391304 289.391304s-289.391304-129.113043-289.391304-289.391304L801.391304 554.295652z"/>\n'+
            '                                <path d="M674.504348 349.495652m-57.878261 0a2.6 2.6 0 1 0 115.756522 0 2.6 2.6 0 1 0-115.756522 0Z"/>\n'+
            '                                <path d="M347.269565 349.495652m-57.878261 0a2.6 2.6 0 1 0 115.756522 0 2.6 2.6 0 1 0-115.756522 0Z"/>\n'+
            '                            </svg>\n'+
            ...
            '                            <svg class="icon" fill="#c2c6cc" viewbox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200">\n'+
            '                                <path d="M15.515152 15.515152 15.515152 15.515152 15.515152 15.515152Z"/>\n'+
            ...
            '    <a href="javascript:;" class="comment-loadmore" target="_blank" rel="external">加载更多</a>\n'+
            '</div>\n'+
    ...
    iDisqus.prototype.load = function(post){
        ...
        var parentPost = !!post.parent ? {
            name: '<a class="comment-item-pname" href="#'+parentPostDom.id+'"><svg class="icon" viewbox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="200" height="200"><path d="M1.664 902.144s97.92-557.888 596.352-557.888V129.728L1024 515.84l-425.984 360.448V628.8c-270.464 0-455.232 23.872-596.352 273.28"/></svg>' + parentPostDom.dataset.name + '</a>',
        ...
        var html = '<li class="comment-item" data-id="' + post.id + '" data-name="'+ post.name + '" id="comment-' + post.id + '">' +
            ...
            '<div class="comment-item-footer">' + (!!post.isPost ? '<span class="comment-item-manage"><a class="comment-item-edit" href="javascript:;" target="_blank" rel="external">编辑</a><span class="comment-item-bullet"> • </span><a class="comment-item-delete" href="javascript:;" target="_blank" rel="external">删除</a><span class="comment-item-bullet"> • </span></span>' : '') + '<a class="comment-item-reply" href="javascript:;" target="_blank" rel="external">回复</a> </div>'+
            '</div></div>'+
    ...
    iDisqus.prototype.upload = function(e){
        ...
        xhrUpload.upload.addEventListener('load', function(e){
            ...
            var imageItem = '<li class="comment-image-item loading" data-image-size="' + size + '">\n'+
                ...
                '        \n'+
                '    </animate></animate></animate></animate></animate></animate></animate></animate></animate></svg>\n'+
                '</li>\n';
    ...
    iDisqus.prototype.edit = function(post){
        ...
        // 取消编辑
        item.querySelector('.comment-actions-form').insertAdjacentHTML('afterbegin', '<a class="comment-form-cancel" href="javascript:;" target="_blank" rel="external">取消</a>')
...
</\></\></button></\></\></textarea></\></label></div></\></\></label></div></\></\></label></div></\></\></label></div></\></\></label></div></\></p></div></\></\></span></div></label></label>